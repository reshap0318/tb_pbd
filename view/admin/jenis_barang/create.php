...
<li class="breadcrumb-item"><a href="/tb_pbd/view/admin/jenis_barang/index.php">Jenis Barang</a>
...
<div class="card">
    <div class="card-block">
        <form id="second" action="/tb_pbd/controller/jenis_barangController.php?aksi=create" method="post" novalidate>
            <?php include $_SERVER['DOCUMENT_ROOT'].'/tb_pbd/view/admin/jenis_barang/_field.php'; ?>
            <div class="row">
