                ...
                ?>
                  <tr>
                      ...
                      <td style="width:100px">
                        <a href="/tb_pbd/view/admin/satker/detail.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-mini waves-effect waves-light">Detail</a>
                        <a href="/tb_pbd/view/admin/satker/edit.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-mini waves-effect waves-light">Edit</a>
  ...
  <script type="text/javascript">
      $('#tablesatker').DataTable(
        ...
        buttons: [
        {
            ...
            {
              window.location.assign("/tb_pbd/view/admin/satker/create.php");
            }
        },
        {
            extend: 'copy',
